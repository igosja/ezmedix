        ...
        <div class="tab-content">
            <div class="tab-pane fade in active" id="main">
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        <td class="col-lg-3">
                            <?= $form->labelEx($model, 'schedule_ru'); ?>
                        </td>
                        <td>
                            <?= $form->textArea($model, 'schedule_ru', array('class' => 'form-control')); ?>
                            <?= $form->error($model, 'schedule_ru'); ?>
                        </td>
                    </tr>
                    <tr>
                        <td class="col-lg-3">
                            <?= $form->labelEx($model, 'schedule_uk'); ?>
                        </td>
                        <td>
                            <?= $form->textArea($model, 'schedule_uk', array('class' => 'form-control')); ?>
                            <?= $form->error($model, 'schedule_uk'); ?>
                        </td>
                    </tr>
                    <tr>
