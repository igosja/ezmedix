...
class m170913_090739_pageabout extends CDbMigration
{
    public function up()
    {
        $this->createTable('pageabout', array(
            ...
            'h3_ru' => 'varchar(255)',
            'h3_uk' => 'varchar(255)',
            'image_1_id' => 'int(11) default 0',
            'image_2_id' => 'int(11) default 0',
            'image_3_id' => 'int(11) default 0',
            'image_4_id' => 'int(11) default 0',
            'text_1_ru' => 'text',
            'text_1_uk' => 'text',
            'text_2_ru' => 'text',
            'text_2_uk' => 'text',
        ...
        $this->insert('pageabout', array(
            'h1_ru' => 'О нас',
            'h1_uk' => 'Про нас',
            'h3_ru' => 'Мы молодая и перспективная команда',
            'h3_uk' => 'Мы молодая и перспективная команда',
            'text_1_ru' => '<p>
